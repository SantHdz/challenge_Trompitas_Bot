...
def buscar_informacion(pregunta: str) -> str:
    """Busca información de la clínica Trompitas Dental (servicios, precios, horarios,
    ubicación, políticas, promociones, urgencias) en la base de conocimiento oficial.
    Úsala para responder cualquier duda del usuario sobre la clínica."""
...
@tool
def agendar_cita(nombre_paciente: str, fecha: str, hora: str, servicio: str, telefono: str) -> str:
    """Registra una solicitud de cita en la clínica. Úsala SOLO cuando tengas TODOS los datos:
    ...
    return (
        f"Cita registrada correctamente para {nombre_paciente} el {fecha} a las {hora} "
